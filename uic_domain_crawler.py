...
retrieved_pages_folder = "./RetrievedPages/"
...
ignored_files = [".pdf",".doc",".docx",".ppt",".pptx",".xls",".xlsx",".css",".js",".aspx",".png",".jpg",".jpeg",".gif",".svg",".ico",".mp4",".avi",".tar",".gz",".tgz",".zip"]
    ...
    try:
        ...
        if rqst.status_code == 200:
            ...
            if len(tags_extracted) != 0:
                ...
                output_file = retrieved_pages_folder + str(page_no)
                ...
                for tag in tags_extracted:
                    ...
                    if (
                        ...
                        and not any(ext in link.lower() for ext in ignored_files)
                    ):
...
with open(pickle_folder + "Retrieved_pages_crawled.pickle", "wb") as f:
